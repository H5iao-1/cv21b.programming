    ...
    while(True):
        ...
        if i % opt.valInterval == 0:
            ...
            with open(f'./saved_models/{opt.experiment_name}/log_train.txt', 'a') as log:
                ...
                # keep best accuracy model (on val dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_iter', type=int, default=2000, help='number of iterations to train for')
    parser.add_argument('--valInterval', type=int, default=10, help='Interval between each validation')
    parser.add_argument('--saved_model', default='saved_models/TPS-RCNN-BiLSTM-CTC-Seed1111/best_accuracy.pth', help="path to model to continue training")
